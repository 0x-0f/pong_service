...
class PongGameManager:
	...
	async def finish_game(self): # 게임 종료및 결과 저장 함수
		...
		# 	status=status
		# )
		# winner_mapping = await sync_to_async(PongMapping.objects.create)(
		# 	user_id = winner,
		# 	pong_id=game,
		# 	score=max(self.scores[0], self.scores[1]),
		# )
		# loser_mapping = await sync_to_async(PongMapping.objects.create)(
		# 	user_id = loser,
		# 	pong_id=game,
		# 	score=min(self.scores[0], self.scores[1])
		# )
		...
		# await sync_to_async(winner_mapping.save())
		# await sync_to_async(loser_mapping.save())
		self.status = "saved"
