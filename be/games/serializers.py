...
class PongSerializer(serializers.ModelSerializer):
    winner_user_name = serializers.CharField(source='winner.user_name')
    loser_user_name = serializers.CharField(source='loser.user_name')
...
class RPSSerializer(serializers.ModelSerializer):
    player1_user_name = serializers.CharField(source='player1.user_name')
    player2_user_name = serializers.CharField(source='player2.user_name')
